...
class DetectedObject(genpy.Message):
  _md5sum = "db6710366dc9c079bdc726efa05bdd52"
...
float32 y
float32 z"""
  __slots__ = ['header','id','label','score','color','valid','space_frame','pose','dimensions','variance','velocity','acceleration','pointcloud','convex_hull','pose_reliable','velocity_reliable','acceleration_reliable','indicator_state','behavior_state','user_defined_info']
  _slot_types = ['std_msgs/Header','uint32','string','float32','std_msgs/ColorRGBA','bool','string','geometry_msgs/Pose','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Twist','geometry_msgs/Twist','sensor_msgs/PointCloud2','geometry_msgs/PolygonStamped','bool','bool','bool','uint8','uint8','string[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,label,score,color,valid,space_frame,pose,dimensions,variance,velocity,acceleration,pointcloud,convex_hull,pose_reliable,velocity_reliable,acceleration_reliable,indicator_state,behavior_state,user_defined_info
