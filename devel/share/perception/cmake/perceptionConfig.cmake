...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/nvidia/pointpillars_ws/src/perception)
  set(perception_DEVEL_PREFIX /home/nvidia/pointpillars_ws/devel)
  ...
  set(perception_INSTALL_PREFIX /home/nvidia/pointpillars_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'jz <jz@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/pointpillars_ws/src/perception/${idir}'.  ${_report}")
    endif()
